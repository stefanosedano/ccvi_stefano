...
def get_ranges(centerdate):
    ...
    for year in range(1951,2011):
        for el in list_of_month_and_days.values:
            try:
                file = f"/DATA/REFERENCE/DATASETS/ERA5/precipitation/raw/era5_precipitation/{year}/image_{year}-{str(el[1]).zfill(2)}-{str(el[0]).zfill(2)}.parquet.gzip"
...
if __name__ == '__main__':
    ...
    reference_directory = "/DATA/REFERENCE/DATASETS/ERA5/precipitation/raw/era5_precipitation_reference"
